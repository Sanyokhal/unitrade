<template>
  <header>
    <div class="header-left-wrapper">
      ...
      >
        <option value=1 class="header-left-wrapper-select-option" selected>№1</option>
    ...
    <div class="header-right-wrapper">
      <div class="header-right-wrapper-toggle">
        <span
          ...
          class="header-right-wrapper-toggle-span"
          :class="{
            'header-right-wrapper-toggle-span-active': toggle == 'adversitement',
          }"
        >
          Оголошення
        </span> | 
        ...
        class="header-right-wrapper-toggle-span"
        :class="{
            'header-right-wrapper-toggle-span-active': toggle == 'job',
          }">Робота</span>
      </div>
    </div>
  </header>
...
.header-right-wrapper-toggle-span {
    text-decoration: none;
    color: black;
    border: none;
    cursor: pointer;
}
.header-right-wrapper-toggle-span-active{
    padding: 0 20px;
    font-weight:800;
}
</style>